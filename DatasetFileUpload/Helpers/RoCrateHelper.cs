...
namespace DatasetFileUpload.Helpers;

public static class RoCrateHelper
{
    public static JsonObject GenerateRoCrateManifest(
        string datasetVersionIdentifier, 
        string domain, 
        string eduPersonPrincipalName, 
        IEnumerable<DatasetFileUpload.Models.File> files)
    {
        ...
        graph.Add(new JsonObject
        {
            ...
            ["alternateName"] = datasetVersionIdentifier,
