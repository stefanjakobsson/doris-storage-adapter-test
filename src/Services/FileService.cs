...
internal sealed class FileService(
    ...
    IOptions<GeneralConfiguration> generalConfiguration) : IFileService
{
    ...
    private Models.File ToModelFile(DatasetVersion datasetVersion, FileMetadata file, byte[]? sha256)
    {
        ...
        string name = file.Path[Paths.GetPayloadPath(type).Length..];
...
#pragma warning disable CA1308 // Normalize strings to uppercase
            Sha256 = sha256 == null ? null : Convert.ToHexString(sha256).ToLowerInvariant(),
